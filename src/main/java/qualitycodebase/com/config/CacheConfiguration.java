package qualitycodebase.com.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, qualitycodebase.com.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, qualitycodebase.com.repository.UserRepository.USERS_BY_EMAIL_CACHE);
